...
Shader "AdultLink/HorizontalDissolve"
{
	Properties
	{
		_Fill("Fill", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert( appdata_full v )
			{
				...
				o.tSpace0 = float4( worldBinormal.x, worldNormal.x, worldBinormal.x, worldPos.x );
				o.tSpace1 = float4( worldBinormal.y, worldNormal.y, worldBinormal.y, worldPos.y );
				o.tSpace2 = float4( worldBinormal.z, worldNormal.z, worldBinormal.z, worldPos.z );
